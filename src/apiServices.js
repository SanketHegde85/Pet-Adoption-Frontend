export class API {
    ...
    static getPetDetails() {
        return fetch('https://pet-adoption-application.onrender.com/api/pet_details/', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    static getCategory() {
        return fetch('https://pet-adoption-application.onrender.com/api/category/', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    static getAdoptions() {
        return fetch('https://pet-adoption-application.onrender.com/api/adoption_details/', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    static getDonations() {
        return fetch('https://pet-adoption-application.onrender.com/api/donations/', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            }
